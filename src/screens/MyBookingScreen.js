...
const MyBookingScreen = () => {
  ...
  useEffect(() => {
    fetch("https://timezoneeee.herokuapp.com/bookings")
      .then((res) => res.json())
      .then((data) =>
  ...
  const handleDelete = (id) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://timezoneeee.herokuapp.com/bookings/${id}`)
          .then((res) => {
  ...
  return (
    <div>
      <Navbar bg="bg-gray-600" textColor="text-black" width="max-w-screen-xl" />
            ...
            {loading ? (
              ...
              <>
                {myBookings.length > 0 ? (
                  ...
                  <div className="h-70 space-y-6 flex items-center justify-center  flex-col">
