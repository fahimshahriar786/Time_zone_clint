...
const TourPackCard = (props) => {
  ...
  const handleDelete = (id) => {
    console.log(id);
    const url = `https://timezoneeee.herokuapp.com/Devices${id}`;
    fetch(url, {
      method: "DELETE",
    })
      .then((res) => res.json())
    ...
    <div className="bg-white rounded-xl p-4 box-border overflow-hidden relative flex flex-col justify-between">
      ...
      <div className="flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 border-b  py-4">
          ...
          {/* group  */}
          <div className="flex items-center space-x-3">
            <MdProductionQuantityLimits className="text-gray-900 text-2xl" />
            <div className="flex flex-col">
              <p className="text-sm font-primary text-gray-700">Availability</p>
